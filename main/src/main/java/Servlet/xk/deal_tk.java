...
@WebServlet(name="deal_tk",value = "/deal_tk")
public class deal_tk extends HttpServlet {
    public void init(){
    }
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        String[] xk=request.getParameterValues("tk");
        ...
        if(xk!=null){
            for(String haha:xk){
                ...
                String sql="delete from E where(xh='"+xh+"'and xq='"+xq+"'and kh='"+kh+"'and gh='"+gh+"');";
                temp.DBupdate(sql);
            }
        }
